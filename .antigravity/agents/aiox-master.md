...
- CineGestão Backend → Use @backend-lead (Subs: @database-mongo, @business-logic-express in /backend)
- CineGestão Frontend → Use @frontend-lead (Subs: @dev-mobile, @ui-ux-design, @frontend-integration in /frontend)
- CineGestão Reports → Use @reports-sava (Subs: @devops-github in /governance)
